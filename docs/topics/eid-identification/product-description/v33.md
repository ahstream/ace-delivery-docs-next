...
eID Identification is a function in Telia ACE which allows visitors to identify themselves with electronic identification (eID) in chat and phone calls. Visitor identity (name and social security number) is shown to agent in ACE Interact. Identification can be done using external trusted identity providers (like BankID, Finnish BankID, Freja eID) supported by ACE Identity Hub, or by letting the ACE customer website supply their own visitor identification token to ACE.
...
![ACE eID identification with Telia Tunnistus example screenshots](./assets/eid-sample-tunnistus.png)
...
![Chat entrance visitor name configuration](./assets/ace-admin-chat-entrance-visitor-name.png)
...
![Chat entrance visitor name configuration](./assets/ace-admin-chat-entrance-phrases.png)
...
![Configuration of contact data window in ACE Interact for chat contacts](./assets/ace-admin-contact-data-window-chat.png)
...
![Configuration of current contacts list in ACE Interact](./assets/ace-admin-current-contacts-config.png)
...
![Configuration of waiting lists in ACE Interact](./assets/ace-admin-waiting-list-config.png)

- Above is a typical setup.

#### ACE Interaction View > Contact data, basic configuration

![Basic configuration of contact data](./assets/ace-admin-contact-data-basic-config.png)
...
![Basic configuration of contact data](./assets/ace-admin-contact-data-exceptions.png)
...
![Basic configuration of contact data](./assets/ace-admin-iv-storage-rules.png)
...
![Visitor is requested to identify before chat can be started](./assets/screenshots/eid-required-tunnistus-10.png)

![Telia Tunnistus available identification methods are shown](./assets/screenshots/eid-required-tunnistus-26.png)

![Ålandsbanken identification method](./assets/screenshots/eid-required-tunnistus-30.png)

![Identification finished](./assets/screenshots/eid-required-tunnistus-40.png)

![Visitor starts chat](./assets/screenshots/eid-required-tunnistus-60.png)

![Agent picks chat.](./assets/screenshots/eid-required-tunnistus-70.png)

### Chat, optional identification with Swedish BankID (Conversational Widget)

![Agent is waiting for chat](./assets/screenshots/eid-optional-bankid-10.png)

![Chat is queued](./assets/screenshots/eid-optional-bankid-20.png)

![Agent picks chat](./assets/screenshots/eid-optional-bankid-30.png)

![Agent clicks fingerprint button to initiate user identification](./assets/screenshots/eid-optional-bankid-40.png)

![Visitor identifies with BankID](./assets/screenshots/eid-optional-bankid-50.png)

![Visitor is identified](./assets/screenshots/eid-optional-bankid-60.png)
...
TODO: Add screenshots how Web SDK legacy authentication looks.

### Phone call eID Identification by ACE Identity Hub Web

TODO: Add screenshots how this looks.
